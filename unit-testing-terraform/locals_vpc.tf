locals {
  vpc = {
    ...
    stage = {
      arryw-stage-dublin = ["eu-west-1", "10.0.2.0/23", ["10.0.2.0/26", "10.0.2.64/26", "10.0.2.128/26"]]
    }
    prod = {
  ...
  public_routes = {
    ...
    stage = {
      some_public_eni_route = ["eu-west-1", "arryw-stage-dublin", "eni", "192.168.2.0/23"]
      some_public_route     = ["eu-west-1", "arryw-stage-dublin", "igw", "8.8.8.8/32"]
    }
    prod = {
